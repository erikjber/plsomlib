 ...
 *
 */
public class MultilayerRecursivePLSOM2
{
    // Weights 
     ...
     * 
     */
    public MultilayerRecursivePLSOM2( double alpha,int inputDim, double neighbourhoodRange, int ... dimensions)
    {
        this.alpha = alpha;
     ...
     * Used for cloning.
     */
    private MultilayerRecursivePLSOM2()
    {
    }
     ...
     */
    public void setOtherNet(MultilayerRecursivePLSOM2 other)
    {
        this.otherNet = other;
     ...
     */
    public void setOtherNetManual(MultilayerRecursivePLSOM2 other)
    {
        this.otherNet = other;
    }
    ...
    {
        MultilayerRecursivePLSOM2 res = new MultilayerRecursivePLSOM2();
        res.alpha = alpha;
